...
public class HashTable01 {
    public static void main(String[] args) {
        ...
        *i)"HashMap" "thread-safe" degildir "HashTable" "thread-safe" dir.
        ...
        iii)"HashMap" hizlidir, "HashTable" "HashMap"e gore yavastir.(yukardaki ilk maddededn dolayi)
        ...
        // HashTable'larin keylerine de valuelerine de null konulamaz

        //stdAges.put(null,85);
      //  stdAges.put("Chris",null);

//        stdAges.elements(); Maplere gore bir element() metodunun farkli oldugunu gorduk
