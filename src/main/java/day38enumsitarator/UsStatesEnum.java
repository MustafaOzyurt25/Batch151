...
//Enumlar degisme ihtimali olmayan datalari depolamak icin kullanilir. Mesela gun isimleri, Monday, Tuesday...;Eyalet isimleri gibi.
//Eger applicationda gun isimleri kullanirsak bu "gun" isimleri veya "ay" isimleri enumda depolanir.
//Nicin bunu yapariz? Cunku application kendi basina ayakta durmalidir.(Stand Alone)Google'a veya baska bir kaynaga bagimli kalmamak icin
...
public enum UsStatesEnum {
    ...
    //  State kisaltmasini verince state ismini veren kod olusturunuz
