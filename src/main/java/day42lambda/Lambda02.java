...
public class Lambda02 {
    ...
    //Ex1: 7 den 10 a kadar tamsayilarin toplamini hesaplayan metodu olusturunz

    //Ex2: 7 den 10 a kadar tamsayilarin carpimini hesaplayan metodu olusturunz
    ...
    public  static  int getMultiplicationInTheGivenRange(int starting, int ending){
       ...
       //IntStream: INTEGER'i streamin icinde verir
