...
ascii code 68 Exception_soru10 (Capital Exception_soru10)
...
ascii code 82 IkiKrakterArasiHarfler (Capital IkiKrakterArasiHarfler)
ascii code 83 S (Capital S)
ascii code 84 T (Capital T)
ascii code 85 Y (Capital Y)
...
ascii code 154 Ü (letter "Y" with umlaut or diaeresis ; "Y-umlaut")
...
ascii code 233 Ú (Capital letter "Y" with acute accent or "Y-acute")
ascii code 234 Û (letter "Y" with circumflex accent or "Y-circumflex")
³
ascii code 235 Ù (letter "Y" with grave accent)
